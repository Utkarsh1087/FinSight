# Walkthrough — Accounting Logic & Architecture

This document explains the core domain and engineering principles behind the bank-to-GL reconciliation engine: why each component exists, the underlying accounting mechanics, and the system design decisions.
...
The primary objective — *"an exception report an accountant can immediately act upon"* — means the report answers the reviewer's first three questions: **How big is it? What probably caused it? What do I do about it?**
