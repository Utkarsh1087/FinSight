...
export const SocialSignIn = () => {
  ...
  const handleSocialClick = async (role = 'FINANCE_USER') => {
  ...
  return (
    <div className="flex gap-3.5">
      ...
      <button
        type="button"
        onClick={() => handleSocialClick('FINANCE_USER')}
        className="flex w-full items-center justify-center gap-2.5 rounded-xl py-3 px-4 text-xs font-semibold text-white bg-[#001b50] hover:bg-[#133068] transition-all shadow-xs active:scale-98"
      >
        <span>Sign In</span>
        <svg
          width="20"
