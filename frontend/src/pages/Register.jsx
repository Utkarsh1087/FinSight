...
export const Register = () => {
  ...
  const handleSocialClick = (provider) => {
    setError(`Direct ${provider} SSO signup requires enterprise SAML setup. Please create an account with your corporate email.`);
  };
          ...
          <div className="max-w-md mx-auto w-full space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs sm:text-sm text-black/50">
                Create your FinSight account to start operating ledgers!
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-xs text-midnight_text focus:outline-none focus:ring-2 focus:ring-primary shadow-xs"
                  >
              ...
              <div className="pt-1">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  ...
                  <span className="text-xs text-slate-600 font-medium">
                    I agree to the{' '}
                    <Link to="/terms-and-conditions" className="font-bold text-primary hover:underline">
                      Terms & Conditions
                    </Link>{' '}
                    and{' '}
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#001b50] relative flex-col items-center justify-center p-12 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-md space-y-4">
          ...
          <p className="text-sm text-white/70 font-normal leading-relaxed pt-2">
            Automate bank-to-GL cash matching, accounts payable aging, multi-warehouse stock ledgers, and fraud prevention with integer-cents accuracy.
          </p>
